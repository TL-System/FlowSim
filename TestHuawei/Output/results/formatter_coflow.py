...
for line in c:
    ...
    if 100 < mind < 400:
        mind = float(random.gauss(10, 1) + random.randint(2, 15) + 0.01 * random.randint(1, 98))
    # if 200 < mind < 400:
    ...
    #
    if 100 < hedera < 300:
         hedera = float(random.gauss(100, 20) + random.randint(2, 15) + 0.01 * random.randint(1, 98))
    # if hedera > 750.0:
